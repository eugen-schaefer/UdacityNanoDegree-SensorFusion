...
void cityBlock(pcl::visualization::PCLVisualizer::Ptr &viewer, ProcessPointClouds<pcl::PointXYZI> &point_processor_I,
...
void initCamera(CameraAngle setAngle, pcl::visualization::PCLVisualizer::Ptr &viewer) {
  ...
  switch (setAngle) {
    case XY :viewer->setCameraPosition(-distance, -distance, distance, 1, 1, 0);
      break;
    case TopDown :viewer->setCameraPosition(0, 0, distance, 0, 1, 1);
      break;
    case Side :viewer->setCameraPosition(0, -distance, 0, 0, 0, 1);
      break;
